...
if __name__ == '__main__':
    ...
    for stem in ('top', 'kominka'):
        save(f'{stem}.jpg', f'{stem}.webp')
    # CHARM card backgrounds render at roughly 340 CSS px; cap the source at 1000px.
    # shizen.jpg is already 700px wide, so it keeps its original dimensions.
    for stem in ('120', 'taiken', 'shizen'):
        save(f'{stem}.jpg', f'{stem}.webp', (1000, 10000))
